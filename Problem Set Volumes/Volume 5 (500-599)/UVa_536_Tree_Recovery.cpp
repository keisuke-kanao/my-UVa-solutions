...
/*
	...
	To build using Visual Studio 2008:
		cl -EHsc -O2 UVa_536_Tree_Recovery.cpp

	from University of Ulm Local Contest 1997 Problem H
		(http://www.informatik.uni-ulm.de/acm/Locals/1997/)

	For constructing a tree from inorder and post order traversal, see UVa 548 - Tree.
*/
...
int main()
{
	...
	char inorder[nr_letters + 1], preorder[nr_letters + 1];
