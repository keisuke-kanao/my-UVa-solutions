...
/*
	...
	To build using Visual Studio 2008:
		cl -EHsc -O2 UVa_10596_Morning_Walk.cpp
*/

/*
	This is an Eulerian cycle (or circuit) problem.

	Generate an directed unweighted graph where vertices are intersections and edges are roads.
...
bool check_connection(int n, const vector<int>& degrees, const vector< vector<bool> >& graph)
{
